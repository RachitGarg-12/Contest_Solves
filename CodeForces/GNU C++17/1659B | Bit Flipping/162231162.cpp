    ...
    int main() {
        ...
        // #endif 
            ...
            while(t--){
                ...
                if(k%2==0){
                    vector<ll> step(n,0);ll tem=k;string h=s;
                     fo(i,n){
                        //debug(i);debug(h[i]);debug(tem);
                        if(i==n-1 && tem>0){step[i]=tem;
                        if((k-tem)%2){if(h[i]=='1'){h[i]='0';}
                        else{h[i]='1';}}
                        continue;}
                        if(h[i]=='0'){if(tem>0){tem--;h[i]='1';step[i]=1;}}
                     }
                     cout<<h<<nl;
                     fo(i,n){cout<<step[i]<<" ";}
                }
                  ...
                  vector<ll> step(n,0);ll tem=k;string h=s;
                     fo(i,n){
                        ...
                        continue;}
                        if(h[i]=='0'){h[i]='1';step[i]=0;}
                        else{ if(tem>0){tem--;step[i]=1;}
                           else{h[i]='0';} }
                     }
                     cout<<h<<nl;
