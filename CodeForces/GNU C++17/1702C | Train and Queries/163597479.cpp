    ...
    /*--------------------------------------------------------------------------------------------------------------------------*/
            ...
            int main() {
                ...
                ll tt;cin>>tt;
                while(tt--){       
                    ll n,k;cin>>n>>k;map<ll,ll> st;map<ll,ll> en;
                    ll a[n+1];f1(i,n){cin>>a[i];
                    if(st[a[i]]==0){st[a[i]]=i;en[a[i]]=i;}
                    else{en[a[i]]=i;}}
                   
                    while(k--){
                            ll s,e;cin>>s>>e;
                            if(st[s]==0 || en[e]==0){cout<<"NO"<<nl;continue;}
                           if(st[s]<en[e]){cout<<"YES"<<nl;}
                           else{cout<<"NO"<<nl;}
                    }
                }  
                    return 0;
