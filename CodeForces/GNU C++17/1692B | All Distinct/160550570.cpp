    ...
    int main() {
        ...
        while(t--){
           ll n;cin>>n;
           set<ll> m;map<ll,ll> l;
           fo(i,n){ll x;cin>>x;m.insert(x);l[x]++;}
           ll ext=0;
           for(auto i:l){
                    ext += i.second-1;
           }
           if(ext%2){cout<<n-ext-1<<endl;}
           else{cout<<n-ext<<endl;}
        //   if(n%2==0){cout<<m.size()<<endl;}
        //   else{if(m.size()%2==0){cout<<m.size()-1<<endl;}
